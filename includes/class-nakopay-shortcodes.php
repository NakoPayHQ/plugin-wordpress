...
class NakoPay_Shortcodes
{
    ...
    public static function enqueue_assets(): void
    {
        ...
        $css = '.nakopay-btn{display:inline-block;padding:.6em 1.2em;background:#f7931a;color:#fff;border-radius:6px;text-decoration:none;font-weight:600}'
             . '.nakopay-btn:hover{filter:brightness(1.05)}'
