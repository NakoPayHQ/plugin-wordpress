...
If you run a WooCommerce store with cart and checkout, install "NakoPay for WooCommerce" instead.
...
1. Download `nakopay.zip` from
   https://github.com/NakoPayHQ/plugin-wordpress/releases/latest/download/nakopay.zip (do NOT unzip).
